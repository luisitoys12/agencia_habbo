<?php
// CRITICO: session_start() y headers SIEMPRE antes de cualquier output HTML
...
if (isset($_SESSION['rol_id'])) {
    $rol = $_SESSION['rol_id'];
    switch ($rol) {
        case 1: $menu = '../private/menus/menu_rangos_bajos.php'; break;
        case 2: $menu = '../private/menus/menu_rangos_medio.php'; break;
        case 3: $menu = '../private/menus/menu_rangos_altos.php'; break;
        case 4: $menu = '../private/menus/menu_rangos_due%C3%B1os.php'; break;
        default:
