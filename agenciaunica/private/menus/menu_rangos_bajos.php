<?php
// Rango bajo — mismo menú que altos pero sin Sanciones ni gestión avanzada
...
<nav class="navbar navbar-dark fixed-top" style="background-color:#2d1b32;">
  <div class="container-fluid">
    ...
    <div class="offcanvas offcanvas-start text-white" tabindex="-1" id="userInfoCanvas" style="background:#2d1b32;">
      <div class="offcanvas-header"><h5>Mi Perfil</h5><button class="btn-close text-reset" data-bs-dismiss="offcanvas"></button></div>
      <div class="offcanvas-body text-center">
        ...
        <?php if ($mis_sanciones > 0): ?><div class="alert alert-danger mt-3 p-2 small"><i class="fa fa-ban"></i> <?= $mis_sanciones ?> sanción(es) activa(s).</div><?php endif; ?>
        <hr style="border-color:#a57db5;">
    ...
    <div class="offcanvas offcanvas-end text-white" style="background:#2d1b32;" tabindex="-1" id="offcanvasMenu">
      <div class="offcanvas-header"><h5>MENÚ</h5><button class="btn-close text-reset" data-bs-dismiss="offcanvas"></button></div>
      <div class="offcanvas-body">
        <ul class="navbar-nav">
          ...
          <li class="nav-item"><a class="nav-link <?= $page_actual==='RAG'?'text-warning':'text-white' ?>" href="/index.php?page=RAG"><i class="fa fa-medal me-2"></i>Rangos</a></li>
          <li class="nav-item"><a class="nav-link <?= $page_actual==='NOT'?'text-warning':'text-white' ?>" href="/index.php?page=NOT"><i class="fa fa-newspaper-o me-2"></i>Noticias</a></li>
          ...
          <li class="nav-item mt-3"><a href="/logout.php" class="btn btn-danger w-100"><i class="fa fa-sign-out me-2"></i>Cerrar sesión</a></li>
        </ul>
      </div>
    </div>
  </div>
